        ...
        if (splitMessage[0] == "!karma") {
            ...
            if (splitMessage.length === 1) {
                ...
                if (stringIsPositiveInteger(arg)) {
                	...
                	message = getIssueInformation({user: config.githubUser, repo: config.githubRepo, issue: arg });
                } else {
            	...
            	message = getIssueInformation({user: splitMessage[1], repo: splitMessage[2], issue: splitMessage[3]});
            }
            if(message.then) {
